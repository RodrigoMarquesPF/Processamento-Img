...
kernel_mascara=kernel_mascara *255
...
for i in range(imagem.shape[0]):
    for j in range(imagem.shape[1]):
        if((imagemPB[i][j]==0) and (imagemPB[i][j+1]==0)and (imagemPB[i][j+2]==0)and (imagemPB[i+1][j]==0)and (imagemPB[i+1][j+1]==0)and (imagemPB[i+1][j+2]==0) and (imagemPB[i+2][j]==0) and (imagemPB[i+2][j+1]==0) and (imagemPB[i+2][j+2]==0) ):
            imagem3[i, j] = 0
